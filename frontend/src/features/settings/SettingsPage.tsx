        ...
        {[
          ...
          <button
            ...
            className={`flex items-center gap-2 border-b-2 px-4 py-2 text-sm font-medium transition-colors ${
              tab === t.id ? 'border-cyan-500 text-cyan-400' : 'border-transparent text-gray-400 hover:text-white'
            }`}
          >
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <ChartCard title="Platform Preferences">
          <div className="space-y-4">
            <div>
              ...
              <select className="mt-1 w-full rounded-md border border-gray-700 bg-gray-900 px-3 py-2 text-sm text-white">
        ...
        <ChartCard title="Integrations">
          <div className="space-y-3">
            <div className="flex items-center justify-between rounded-md bg-gray-900/50 p-3">
              <div>
